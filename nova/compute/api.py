...
class API(base.Base):
    ...
    def create(self, context, instance_type,
        ...
        #NOTE:(schoksey): If external storage based flavor and block device mapping is empty; create a bootable volume;
	    ...
	    volume_size = instance_type['root_gb'] or image_detail[1]['size']/volume_size_gb
            ...
            #NOTE:(schoksey): adding logic to wait until bdm is in "available" state
    ...
    #NOTE:(schoksey): Check if "vda" device name exists in block_device_mapping
